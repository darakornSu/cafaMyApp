            ...
            children: <Widget>[
                ...
                child: Stack(
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: Image.asset("${furnitures[1]["img"]}",
                        //"${furnitures[0]["img"]}",
                        height: 240,
                        width: MediaQuery.of(context).size.width,
                        fit: BoxFit.cover,
              ...
              Text(
                "Sed porttitor lectus nibh. Cras ultricies ligula "
                    ...
                    "porttitor at sem.porttitor lectus nibh. Cras ultricies ligula "
                    "sed magna dictum porta. Praesent sapien massa, "
                    "convallis a pellentesque nec, egestas non nisi. "
                    "Lorem ipsum dolor sit amet, consectetur adipiscing "
                    "elit. Nulla porttitporttitor lectus nibh. Cras ultricies ligula "
                    "sed magna dictum porta. Praesent sapien massa, "
                    "convallis a pellentesque nec, egestas non nisi. "
                    "Lorem ipsum dolor sit amet, consectetur adipiscing "
                    "elit. Nulla porttitporttitor lectus nibh. Cras ultricies ligula "
